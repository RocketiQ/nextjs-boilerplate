...
export default function ResearchEngineerInternApply() {
    ...
    if (res.ok) {
      ...
      if (typeof window !== 'undefined' && (window as any).gtag) {
        (window as any).gtag('event', 'application_submitted', {
          job_slug: 'research-engineer-intern',
        });
      }
      formEl.reset();
      setQualification('');
  ...
  // Typography helpers (kept consistent with your other pages)
    ...
    <main>
      ...
      <div className="apply-shell">
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <h1 style={{ fontSize: 28, margin: '12px 0 0' }}>Research Engineer Intern</h1>
        </div>
        ...
        <div className="careers-grid">
          ...
          <section className="card-dk">
            ...
            <ul style={{ listStyleType: 'disc', paddingLeft: '1.25rem', marginTop: 0 }}>
              <li>Write a scoped technical plan with milestones, metrics, and references.</li>
              <li>Scaffold a clean repo (<code>src/</code>, <code>scripts/</code>, <code>cases/</code>, <code>tests/</code>, <code>docs/</code>, <code>env/</code>) with Apache-2.0 license and CITATION (or appropriate proprietary structure).</li>
              <li>Implement core algorithms (Python; C++ welcome where appropriate).</li>
              <li>Add manifests/cases, reference outputs, and a compute log (wall-time, hardware).</li>
              <li>Create tests (smoke + invariants/metrics) and enable CI (GitHub Actions).</li>
              <li>Document everything: README quickstart, METHODS (equations/assumptions), RESULTS (figures + commands).</li>
              <li>Prepare a minimal contribution guide and PR template.</li>
            </ul>

            <h2 style={h2Next}><strong>Qualifications</strong></h2>
            <ul style={{ listStyleType: 'disc', paddingLeft: '1.25rem', marginTop: 0 }}>
              <li>Bachelor’s graduate OR master’s student (pursuing/graduate) OR PhD student (pursuing/graduate).</li>
              <li>Strong Python skills; plus one of C++/MATLAB/Julia is a bonus.</li>
              <li>Solid Git workflow (branching, PRs, code review) and comfort with CI/testing.</li>
              <li>Ability to derive models from first principles and validate against references.</li>
              <li>Clear, reproducible documentation; attention to detail.</li>
              <li>Nice to have: OpenFOAM/Cantera/ROS2, PyTorch/TF, MkDocs/Sphinx, basic Docker, GPU know-how.</li>
            </ul>
            ...
            <ul style={{ listStyleType: 'disc', paddingLeft: '1.25rem', marginTop: 0 }}>
              ...
              <li><strong>Time:</strong> ~2–3 hrs/day, flexible</li>
            ...
            <p style={{ marginTop: 16 }}>
              For questions or clarifications, contact <a href="mailto:contact@therocketiq.com">contact@therocketiq.com</a>
            </p>
          </section>

          {/* Right: Apply form (unchanged structure; résumé only) */}
          <section className="card-dk">
            <h2 style={h2First}><strong>Apply Now</strong></h2>

            <form onSubmit={onSubmit}>
              <input type="hidden" name="job_slug" value="research-engineer-intern" />
